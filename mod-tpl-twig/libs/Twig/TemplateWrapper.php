...
final class Twig_TemplateWrapper
{
   ...
   //   return $this->template->render($context, func_num_args() >= 1 ? func_get_arg(1) : []);
        return $this->template->render($context, func_num_args() > 1 ? func_get_arg(1) : []); // fix by unixman: https://github.com/twigphp/Twig/commit/361d864178ea6abb86722633b6c9bd509a6e9930
    }
