...
final class SmartAppTaskController extends SmartAbstractAppController {
	...
	public function Run() {
		...
		//--
		$max_execution_time = (int) ((Smart::array_size($arr_realms) + 1) * (int)self::OPTIMIZATIONS_MAX_RUN_TIMEOUT);
		//--
		...
		$this->PageViewSetVars([
			...
			'main' 		=> SmartMarkersTemplating::render_file_template(
				...
				[
					...
					//--
					'PAGE' 					=> (string) $this->ControllerGetParam('module').'.task-optimize-json-docs',
					//--
