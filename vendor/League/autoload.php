...
/**
 * Function AutoLoad Extra Libs for Vendor / League (HTMLToMarkdown)
 ...
 *
 */
function autoload__VendorLeague($classname) {
	//--
	...
	//--
	if(strpos($classname, 'League\\') === false) { // must start with this namespaces only
		return;
	} //end if
	//--
...
//--
spl_autoload_register('autoload__VendorLeague', true, false); // throw / append
//--
