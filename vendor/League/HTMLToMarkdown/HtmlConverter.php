...
// modified by unixman, contain fixes:
// 		* strip html comments (which are handled in a wrong way)
// 		* detect if PHP DOM extension exists
...
class HtmlConverter implements HtmlConverterInterface
{
	...
	{
		//--#fix: check if PHP DOM extension is loaded :: unixman
		if(!class_exists('\\DOMDocument')) {
			throw new \Exception('PHP DOM Extension is missing ...');
		}
		//--#
