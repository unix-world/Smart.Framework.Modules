...
class Shard implements KeyValueStore
{
	 ...
	 */
	public function __construct(KeyValueStore $cache1, ?KeyValueStore $cache2 = null /* , [KeyValueStore $cache3, [...]] */) // unixman: PHP 8.4 nullable fix
	{
	 ...
	 * {@inheritdoc}
	 */
	public function getMulti(array $keys, ?array &$tokens = null) // unixman: PHP 8.4 nullable fix
	{
