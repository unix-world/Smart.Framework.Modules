<?php
// [@[#[!SF.DEV-ONLY!]#]@]
// Controller: Twist Templating Debug r.20260130
// Route: ?/page/tpl-twist.debug (?page=tpl-twist.debug)
...
class SmartAppIndexController extends SmartAbstractAppController {
	...
	public function Run() {
		...
		if(!$this->IfDebug()) {
			$this->PageViewSetErrorStatus(404, 'NO Twist-TPL-DEBUG Service has been activated on this server ...');
			return;
		} //end if
		//--
		...
		$this->PageViewSetVar(
			...
			(string) SmartDebugProfiler::display_debug_page(
				'{{ Twist-TPL }} Template Debug Profiling',
				(string) \SmartModExtLib\TplTwist\SmartTwistTemplating::debug((string)$tpl)
			)
		);
		//--
