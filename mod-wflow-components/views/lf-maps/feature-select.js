...
L.FeatureSelect = L.Class.extend({
	...
	_checkIntersections: function() {
		...
		this.options.featureGroup.eachLayer(function(layer) {
			...
			//-- bugfix by unixman
			if(typeof layer.feature == 'undefined') { // new created features may have this but not mandatory
				return;
			} //end if
			if(typeof layer.feature.geometry == 'undefined') { // new created features appear not to have this by default
				return;
			} //end if
			if(typeof layer.feature.geometry.coordinates == 'undefined') { // new created features appear not to have this by default
				return;
			} //end if
			//-- #end bugfix
