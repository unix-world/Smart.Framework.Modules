...
// include ("partials/text-salutation.jscad"); // FEATURE DISABLED !
...
function getParameterDefinitions() {
  return [
    ...
    { name: 'date',  type: 'date', initial: '', caption: 'Birthday?', placeholder: 'YYYY-MM-DD' }, // min: '1919-01-01', max: '2119-12-31'
