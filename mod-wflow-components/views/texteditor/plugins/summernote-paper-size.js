...
/*			css: '.note-editor.note-frame.note-document{display:block;overflow:none}' +
					 ...
					 '.note-editor.note-frame.note-document .note-editing-area.a5:after{content:"A0";font-size:32px;font-weight:700;color:#ddd;position:absolute;top:0;right:10px}' +
					 '.note-editor.note-frame.note-document .note-editing-area.a5:after{content:"2384 x 3370";font-size:14px;top:18px;right:55px;' +
					 '}' +
					 '.note-editor.note-frame.note-document .note-editing-area.a1:before{content:"A1";font-size:32px;font-weight:700;color:#ddd;position:absolute;top:0;right:10px}' +
					 '.note-editor.note-frame.note-document .note-editing-area.a1:after{content:"1684 x 2384";font-size:14px;top:18px;right:55px;}' +
					 '.note-editor.note-frame.note-document .note-editing-area.a2:before{content:"A2";font-size:32px;font-weight:700;color:#ddd;position:absolute;top:0;right:10px}' +
					 '.note-editor.note-frame.note-document .note-editing-area.a2:after{content:"1191 x 1684";font-size:14px;top:18px;right:55px;}' +
...
*/
			css: '.note-editor.note-frame.note-document {height:' + '85vh;' + '}' +
				...
				var button = ui.buttonGroup([
					...
					ui.dropdown({
						...
						click: function (e) {
							...
							switch (value){
								case 'A0':
									summertnotePaperSize_A0();
									break;
								case 'A1':
									summertnotePaperSize_A1();
									break;
								case 'A2':
									summertnotePaperSize_A2();
									break;
								case 'A3':
