...
// code-flowchart.js, v.20190205
// (c) 2018-2019 unix-world.org
// License: GPLv3

// this code is based on flowchart.js, v1.11.3, # http://adrai.github.io/flowchart.js
// Copyright (c)2018 Adriano Raiano, License: MIT
					...
					if (chart.start || (chart.start = realSymb), i + 1 < lenS) {
						...
						if(realSymb) {
							...
							try {
								...
								alert('ERROR: Undefined Element: ' + flowSymb);
								return chart;
							}
							direction = null;
						} else {
							alert('WARNING: Undefined Element: ' + flowSymb);
							return chart;
						}
					}
