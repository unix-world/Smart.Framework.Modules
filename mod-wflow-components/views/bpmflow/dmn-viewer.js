...
// Decision Model and Notation (DMN) : Javascript
 ...
 * https://github.com/bpmn-io/dmn-js # https://unpkg.com/dmn-js@6.2.0/dist/
 */
...
(function (global, factory) {
	...
	var BPMNIO_IMG = '<img width="16" height="16" src="' + BPMNIO_LOGO_URL + '" style="opacity:0.5;" />';
	...
	var LIGHTBOX_MARKUP =
		'<div class="djs-powered-by-lightbox" style="' + LIGHTBOX_STYLES + '">' +
	...
	function addProjectLogo(container) {
		...
		var linkMarkup =
			'<a onclick="return false;" href="#" ' +
				'class="djs-powered-by" ' +
				'title="Powered by bpmn.io" ' +
				'style="position: absolute; bottom: 15px; right: 15px; z-index: 100; cursor:default;">' +
				img +
			'</a>';
		...
		componentEvent.bind(linkElement, 'dblclick', function (event$$1) {
			open();
	...
	var ViewDrdComponent = function (_Component) {
		...
		_createClass$m(ViewDrdComponent, [{
			...
			value: function render$$1() {
				...
				return createVNode(1, 'div', 'view-drd', createVNode(1, 'button', 'view-drd-button', createTextVNode('Return to Diagram'), 2, {
