...
class SmartAppAdminController extends SmartAbstractAppController {
	...
	public function Run() {
		...
		$this->PageViewSetVar(
			'main',
			SmartComponents::js_ajax_replyto_html_form(($wr === 1) ? 'OK' : 'ERROR', 'Save Mockup', ($wr === 1) ? 'Mockup Saved Successfuly' : 'Failed to save the Mockup: '.$wr, ($wr === 1) ? 'admin.php?/page/agile.mockup-editor/uuid/'.Smart::escape_url($uuid) : '')
		);
