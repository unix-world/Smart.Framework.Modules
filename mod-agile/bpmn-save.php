...
class SmartAppAdminController extends SmartAbstractAppController {
	...
	public function Run() {
		...
		$this->PageViewSetVar(
			'main',
			SmartComponents::js_ajax_replyto_html_form(($wr === 1) ? 'OK' : 'ERROR', 'Save BPMN-Diagram', ($wr === 1) ? 'BPMN-Diagram Saved Successfuly' : 'Failed to save the BPMN-Diagram: '.$wr, ($wr === 1) ? 'admin.php?/page/agile.bpmn-editor/uuid/'.Smart::escape_url($uuid) : '')
		);
