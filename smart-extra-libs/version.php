...
define('SMART_APP_MODULES_EXTRALIBS_VER', 'm.ext.2022-11-18');
//--

//-- checks the minimum version of the Smart.Framework to run on # v.20221118
define('SMART_APP_MODULES_EXTRALIBS_MIN_FRAMEWORK_VER', 'v.8.7.r.2022.11.18'); // this must be used to validate the required minimum framework version
