...
define('SMART_APP_MODULES_EXTRALIBS_VER', 'm.ext.2025-06-20');
//--

// # PHP 7.4 .. PHP 8.4 ready

//-- checks the minimum version of the Smart.Framework to run on # v.20250620
define('SMART_APP_MODULES_EXTRALIBS_MIN_FRAMEWORK_VER', 'v.8.7.r.2025.06.20'); // this must be used to validate the required minimum framework version
