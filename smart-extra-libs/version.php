...
define('SMART_APP_MODULES_EXTRALIBS_VER', 'm.ext.2021-03-06');
//--

//-- checks the minimum version of the Smart.Framework to run on
define('SMART_APP_MODULES_EXTRALIBS_MIN_FRAMEWORK_VER', 'v.7.2.1.r.2021.03.06'); // this must be used to validate the required minimum framework version
