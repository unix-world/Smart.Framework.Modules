...
define('SMART_APP_MODULES_EXTRALIBS_VER', 'm.ext.2026-08-21');
//--

// # PHP 8.1 .. PHP 8.5 ready

//-- checks the minimum version of the Smart.Framework to run on # v.20260821
define('SMART_APP_MODULES_EXTRALIBS_MIN_FRAMEWORK_VER', 'v.8.7.r.2026.08.21'); // this must be used to validate the required minimum framework version, must not be set ahead ...
