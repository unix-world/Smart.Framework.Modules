...
define('SMART_APP_MODULES_EXTRALIBS_VER', 'm.ext.2023-01-01');
//--

//-- checks the minimum version of the Smart.Framework to run on # v.20230101
define('SMART_APP_MODULES_EXTRALIBS_MIN_FRAMEWORK_VER', 'v.8.7.r.2023.01.01'); // this must be used to validate the required minimum framework version
