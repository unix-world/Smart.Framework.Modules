...
// jQuery Desktop r.0.1
// todo: create the windows dynamic
		...
		init: {
			...
			/*	d.on('mouseenter', 'a.icon', function() {
				...
				d.on('mouseenter', 'div.window', function() {
					...
					var ofs = {}, diffX = 0;
					$(this).resizable({
						handleSelector: "> span.abs",
						resizeWidth: true,
						resizeHeight: true,
						resizeWidthFrom: 'right',
						resizeHeightFrom: 'bottom',
						onDragStart: function(e, $el, opt) { isResizing = true; },
						onDragEnd: function(e, $el, opt) { isResizing = false; },
					});
					...
					//--
					/* jquery event drag
					$(this).find('div.window_inner > div.window_top').bind("dragstart", function(e,d) {
