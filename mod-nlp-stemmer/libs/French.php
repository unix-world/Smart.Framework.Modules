<?php
// Class: \SmartModExtLib\NlpStemmer\French
 ...
 *
 */
final class French extends \SmartModExtLib\NlpStemmer\Stem {
	...
	private function step2b()
	{
		...
		if ( ($position = $this->searchIfInRv(array(
			...
			if ( $this->inRv($before) && ($letter == 'e') ) {
				$this->word = \SmartModExtLib\NlpStemmer\Utf8::substr($this->word, 0, $before);
	...
	{
		$this->word = \SmartModExtLib\NlpStemmer\Utf8::str_replace(array('I','U','Y'), array('i', 'u', 'y'), $this->word);
	}
	...
	protected function rv()
	{
		...
		// (Exceptionally, par, col or tap, at the begining of a word is also taken to define RV as the region to their right.)
		$begin3 = \SmartModExtLib\NlpStemmer\Utf8::substr($this->word, 0, 3);
