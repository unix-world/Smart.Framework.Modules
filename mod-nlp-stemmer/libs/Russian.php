<?php
// Class: \SmartModExtLib\NlpStemmer\Russian
 ...
 *
 */
final class Russian extends \SmartModExtLib\NlpStemmer\Stem {
	...
	public function step4()
	{
		...
		if ( ($position = $this->searchIfInRv(array('нн'))) !== false) {
			$this->word = \SmartModExtLib\NlpStemmer\Utf8::substr($this->word, 0, ($position+1));
			return true;
		}
