<?php
// Class: \SmartModExtLib\NlpStemmer\Norwegian
 ...
 *
 */
final class Norwegian extends \SmartModExtLib\NlpStemmer\Stem {
	...
	private function hasValidSEnding($word)
	{
		...
		if ($lastLetter == 'k') {
			$beforeLetter = \SmartModExtLib\NlpStemmer\Utf8::substr($word, -2, 1);
