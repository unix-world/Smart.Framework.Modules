<?php
// Class: \SmartModExtLib\NlpStemmer\Portuguese
 ...
 *
 */
final class Portuguese extends \SmartModExtLib\NlpStemmer\Stem {
	...
	public function stem($word)
	{
		...
		$this->word = \SmartModExtLib\NlpStemmer\Utf8::str_replace(array('ã', 'õ'), array('a~', 'o~'), $this->word);
	...
	public function finish()
	{
		...
		$this->word = \SmartModExtLib\NlpStemmer\Utf8::str_replace(array('a~', 'o~'), array('ã', 'õ'), $this->word);
	}
