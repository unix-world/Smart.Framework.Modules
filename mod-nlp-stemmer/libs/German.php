<?php
// Class: \SmartModExtLib\NlpStemmer\German
 ...
 *
 */
final class German extends \SmartModExtLib\NlpStemmer\Stem {
	...
	public function stem($word)
	{
		...
		$this->word = \SmartModExtLib\NlpStemmer\Utf8::str_replace('ß', 'ss', $this->word);
	...
	public function finish()
	{
		...
		$this->word = \SmartModExtLib\NlpStemmer\Utf8::str_replace(array('U', 'Y', 'ä', 'ü', 'ö'), array('u', 'y', 'a', 'u', 'o'), $this->word);
	}
