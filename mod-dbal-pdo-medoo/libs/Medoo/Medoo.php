 ...
 *
 * @version 2.1.12 @ head.20241204 # commit:54b340294e576d88ec7750175cade892de3e2c7a
 * @author Angel Lai
 * @package Medoo
...
class Medoo
{
	...
	//	if (isset($options['testMode']) && $options['testMode'] == true) {
		...
		//	$options['database'] = $options['database'] ?? $options['database_name'];
			$options['database'] = $options['database'] ?? $options['database_name'] ?? $options['database_file'] ?? null; // fix by unixman
