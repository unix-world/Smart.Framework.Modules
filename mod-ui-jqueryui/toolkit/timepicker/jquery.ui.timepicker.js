/*
 * jQuery UI Timepicker 0.3.3.smart.1 {{{SYNC-JS-TIMEPICKER-LIB}}}
 * Copyright: 2010-2013, Francois Gelinas, http://fgelinas.com/code/timepicker
 * License: MIT
 *
 * Depends:
 *  jquery.ui.core.js
 ...
 *
 * Contains fixes by unixman, (c) 2011-2016 unix-world.org
 *
*/
	...
	$.extend(Timepicker.prototype, {
		...
		_attachments: function (input, inst) {
			...
			if(showOn == 'button' || showOn == 'both') { // pop-up time picker when 'button' element is clicked
				/* unixman: don't use default button [...]
				var button = this._get(inst, 'button');
				if(button == null) { // Add button if button element is not set
...
*/
		...
		*/
		...
		selectHours: function (event) {
			...
			//this._updateSelectedValue(inst); // fix by unixman :: trigger selected just if both h/m are clicked
