...
class BinaryShiftToken extends Token
{
	...
	public function __construct(?Token $previous, $totalBitCount, $shiftStart, $shiftByteCount) // unixman: removed implicit null 1st param, added nullable type (PHP 8.4 fix)
	{
