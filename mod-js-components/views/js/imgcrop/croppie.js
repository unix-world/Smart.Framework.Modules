...
// modified by unixman (removed embedded promise-polyfill)
...
(function (root, factory) {
	...
	if (typeof Promise !== 'function') {
		// require: promise-polyfill 3.1.0 or later
		console.log('Croppie: A required dependency was not found: promise-polyfill');
		throw 'Promise / promise-polyfill is not available in this browser';
	}
