<?php
// Module Lib: \SmartModExtLib\Cloud\IcalParseFreq # Private class for IcalParser
 ...
 *
 * Modified and adapted by unixman, w. fixes for PHP 7.4 (c) 2018-2020
...
final class IcalParseFreq {
	...
	private $ruleModifiers = ['wkst'];
	private $simpleMode = true;

	private $rules = ['freq' => 'yearly', 'interval' => 1];
	private $start = 0;
	private $freq = '';

	private $excluded; //EXDATE
	private $added;    //RDATE

	private $cache; // getAllOccurrences()
